...
def _default_ollama_system_prompt() -> str:
    return (
        ...
        "2. Preserve ALL formatting tokens and special characters exactly as-is: {0} {1} {playerName} \\n <color=#ff0000> </color> [b] [/b] %s %d — never translate, remove, or modify them. The bracket markers [t0] [/t0] [t1] [/t1] [s0] [s1] AND the mathematical brackets ⟦0⟧ ⟦/0⟧ ⟦1⟧ ⟦/1⟧ ⟦*0⟧ ⟦*1⟧ (any numbered [tN]/[/tN]/[sN]/⟦N⟧/⟦/N⟧/⟦*N⟧) are PROTECTED STRUCTURAL MARKERS. They wrap content you SHOULD translate, but the markers themselves must appear UNCHANGED in your output — same characters, same digits, same count. If you cannot guarantee preservation, output the markers as-is rather than guessing. This includes any unusual Unicode characters or symbols in the input.\n"
